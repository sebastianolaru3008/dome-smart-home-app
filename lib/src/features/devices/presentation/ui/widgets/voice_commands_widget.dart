...
class VoiceCommandsWidget extends StatelessWidget {
  const VoiceCommandsWidget({Key? key, required this.deviceEntity})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          VoiceCommandsBloc(devicesService: locator.get<DevicesService>())
            ..add(LoadVoiceCommandsListEvent(deviceEntity: deviceEntity)),
      child: Scaffold(
        body: Padding(
            ...
            children: [
              Text("Grandparents",
                  style: TextStyle(
                      ...
                      fontSize: 20)),
              VoiceCommandsEnable(
                  deviceEntity.voiceCommandsEnabled, deviceEntity),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return VoiceCommandTileWidget(
                            voiceCommandEntity:
                                deviceEntity.voiceCommands[index],
                            deviceEntity: deviceEntity,
                          );
                        },
                      ),
